...
class pos_details_total(report_sxw.rml_parse):
    ...
    def __init__(self, cr, uid, name, context):
        super(pos_details_total, self).__init__(cr, uid, name, context=context)
        self.total = 0.0
        self.qty = 0.0
...
class report_pos_details_total(models.AbstractModel):
    _name = 'report.point_of_sale.report_detailsofsalestotal'
    _inherit = 'report.abstract_report'
    _template = 'point_of_sale.report_detailsofsalestotal'
    _wrapped_report_class = pos_details_total
